(ns sentei.cells.social-post.state-machine
  "Phase state machine for the 剪定 — Council as Pruner (post-hoc pruning governance) social_post cell — the publication membrane that
